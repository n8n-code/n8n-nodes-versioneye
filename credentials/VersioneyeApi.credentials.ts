...
export class VersioneyeApi implements ICredentialType {
	name = 'N8nDevVersioneyeApi';

	displayName = 'versioneye API';

	icon: Icon = { light: 'file:../nodes/Versioneye/versioneye.png', dark: 'file:../nodes/Versioneye/versioneye.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			default: '',
			required: true,
			placeholder: 'https://www.versioneye.com',
			description: 'The base URL of your versioneye API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
